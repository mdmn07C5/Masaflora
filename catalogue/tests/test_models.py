...
class TestStoresModel(TestCase):
    def setUp(self):
        ...
        Category.objects.create(
            name="Category Test 1", slug="category-test-1", store_id=1
        )
        Category.objects.create(
            name="Category Test 2", slug="category-test", store_id=1
        )
...
class TestMenuItemModel(TestCase):
    def setUp(self):
        ...
        self.data1 = MenuItem.objects.create(
            category_id=1, store_id=1, name="test1", price=69.42, image="Nonelmao"
        )
